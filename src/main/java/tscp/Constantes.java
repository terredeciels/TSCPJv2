...
public interface Constantes {
    ...
    int[] CASES64 = {21, 22, 23, 24, 25, 26, 27, 28, 31, 32, 33, 34, 35, 36, 37, 38, 41, 42, 43, 44, 45, 46, 47, 48, 51, 52, 53, 54, 55, 56, 57, 58, 61, 62, 63, 64, 65, 66, 67, 68, 71, 72, 73, 74, 75, 76, 77, 78, 81, 82, 83, 84, 85, 86, 87, 88, 91, 92, 93, 94, 95, 96, 97, 98};

    int PION = 0,CAVALIER = 1,FOU = 2,TOUR = 3,DAME = 4,ROI = 5;
    boolean[] slide = {false, false, true, true, true, false};
    int[] champ = {0, 8, 4, 4, 8, 8};
    int[][] delta
            = {// dans 8 directions
                {0, 0, 0, 0, 0, 0, 0, 0},//pion
                {-21, -19, -12, -8, 8, 12, 19, 21},//cavalier
                {-11, -9, 9, 11, 0, 0, 0, 0},//fou
                {-10, -1, 1, 10, 0, 0, 0, 0},//tour
                {-11, -10, -9, -1, 1, 9, 10, 11},//dame
                {-11, -10, -9, -1, 1, 9, 10, 11}//roi
            };
